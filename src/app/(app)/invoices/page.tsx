          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-gray-50 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                <th className="px-3 md:px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">Invoice #</th>
                <th className="px-3 md:px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">Client</th>
                <th className="px-3 md:px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase hidden sm:table-cell">Date Issued</th>
                <th className="px-3 md:px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase hidden lg:table-cell">Due Date</th>
                ...
                <th className="px-3 md:px-6 py-3 text-right text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">Actions</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
              {invoiceList.map((inv) => (
                <tr key={inv.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                  <td className="px-3 md:px-6 py-3 font-medium dark:text-gray-200">
                    {inv.invoiceNumber}
                    {inv.isAutoGenerated && (
                  ...
                  <td className="px-3 md:px-6 py-3 text-gray-600 dark:text-gray-400">{inv.client?.name || '-'}</td>
                  <td className="px-3 md:px-6 py-3 text-gray-600 dark:text-gray-400 hidden sm:table-cell">{formatDate(inv.dateIssued)}</td>
                  <td className="px-3 md:px-6 py-3 text-gray-600 dark:text-gray-400 hidden lg:table-cell">{inv.dateDue ? formatDate(inv.dateDue) : '-'}</td>
