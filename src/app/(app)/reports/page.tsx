      ...
      {loading && tab !== 'balance' ? (
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-gray-50 border-b border-gray-200">
                  ...
                  <th className="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase">Unbilled</th>
        ...
        <div className="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden">
          {balanceLoading ? (
            ...
            <div className="p-6 text-center text-gray-500">Select a client to view outstanding items</div>
